...
import { nftaddress, nftABI, nftmarketaddress, nftMarketABI } from "../config";
console.log(process.env.NEXT_PUBLIC_REACT_APP_JSON_RPC_URL)
export default function Home() {
  ...
  async function loadNFTs() {    
    const provider = new ethers.providers.getDefaultProvider('ropsten', {alchemy: process.env.ROPSTEN_URL,})
